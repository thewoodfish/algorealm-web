...
const features = [
  ...
  {
    title: "Stays in Nigeria",
    body: "Every byte of operational data is processed on hardware you control, in the country you operate. No foreign servers. No data-sharing agreements. No dependency on external networks.",
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" strokeWidth="1.5">
